    ...
    <section className="px-6 pb-28 relative">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex justify-center mt-14">
          ...
          <Link
            href="/tools"
            className="inline-flex items-center gap-3 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-400 hover:to-orange-500 text-white px-8 py-4 rounded-2xl font-bold transition-all duration-300 hover:scale-105 shadow-lg shadow-orange-500/20"
          >
